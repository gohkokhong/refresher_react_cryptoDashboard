        ...
        {!loading && !error && (
            <>
                ...
                <div className="coin-details-info">
                    ...
                    <h3>Current Price: SGD${coin.market_data.current_price.sgd.toLocaleString()}</h3>

                    <h4>Market Cap: ${coin.market_data.market_cap.sgd.toLocaleString()}</h4>

                    <h4>24h High: ${coin.market_data.high_24h.sgd.toLocaleString()}</h4>
                    <h4>24h Low: ${coin.market_data.low_24h.sgd.toLocaleString()}</h4>
